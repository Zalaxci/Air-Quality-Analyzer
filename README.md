...
## Οδηγίες για τη χρήση του Raspberry
Ο χρήστης θα πρέπει: 
- Πρώτα από το Raspberry να ανοίξει την κονσόλα
...
- Αφού εμφανιστεί ένα πεδίο "Enter the School ID:", θα πρέπει να πληκτρολογήσει το Username που έχει εισάγει στη βάση δεδομένων του
